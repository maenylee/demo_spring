...
import com.demo.bean07.PropertyValue;
import com.demo.bean07.PropertyValues;
import com.demo.bean07.factory.DisposableBean;
import com.demo.bean07.factory.InitializingBean;
import com.demo.bean07.factory.config.AutowireCapableBeanFactory;
import com.demo.bean07.factory.config.BeanDefinition;
import com.demo.bean07.factory.config.BeanPostProcessor;
import com.demo.bean07.factory.config.BeanReference;
import com.demo.bean07.factory.util.BeanUtil;
...
public abstract class AbstractAutowireCapableBeanFactory
  ...
  protected void registerDisposableBeanIfNecessary(String beanName, Object bean, BeanDefinition beanDefinition) {
    if (bean instanceof DisposableBean || StringUtils.notBlack(beanDefinition.getDestroyMethodName())) {
  ...
  private void invokeInitMethods(String beanName, Object bean, BeanDefinition beanDefinition) throws Exception {
    ...
    if (StringUtils.notBlack(initMethodName)) {
