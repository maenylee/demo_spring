...
import com.demo.bean06.context.support.ClassPathXmlApplicationContext;
...
class Bean06ApplicationTests {
  ...
  public void test_xml() {
    // 1.初始化 BeanFactory
    ClassPathXmlApplicationContext applicationContext = new ClassPathXmlApplicationContext("classpath:spring_06.xml");
